  ...
  return (
    <div className="dashboard_container">
      ...
      {/* {searchInput} */}
        ...
        <div className="input_dashboard_results">


          {searchInput.length > 0 && filterMovies.length === 0 && <p className="no_found_dashboard">"{searchInput}" nomli kino topilmadi :(</p>}
      
        
      <div className="search_input_result">
        {searchInput.length > 0 && filterMovies.length > 0 && filterMovies?.map((kino) => (
      ...
      <div className="movies_dashboard">
        <div className="movie_salavha">
          <h2 className="">So'nggi filmlar</h2>
        </div>
